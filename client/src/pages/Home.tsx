  ...
  return (
    <div id="top" className={darkMode ? "site-shell theme-dark" : "site-shell"}>
      ...
      <main>
        ...
        <section id="start" className="closing-section"><img src="/assets/signalflow-footer-grid.webp" alt="Abstract chartreuse signal line on a dark grid" /><div className="closing-content"><span className="eyebrow eyebrow--light"><span className="eyebrow-line" /> Ready when you are</span><h2>Your customers already told you what to build.</h2><p>Give the signal a place to land. Start with a sample workspace and see what your feedback is trying to say.</p><a className="button button--accent" href="#start" onClick={(event) => { event.preventDefault(); setShowSignup(true); }}>Start for free <ArrowUpRight size={17} /></a></div></section>
      </main>
